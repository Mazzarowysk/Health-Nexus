...
export const getRolePermissions = (user) => {
  ...
  if (username === 'admin' || username === 'mazzarowysk' || role === 'Master') {
    return {
      ...
      allowedTabs: ['dashboard', 'pacientes', 'medicos', 'escalas', 'agenda', 'atendimento', 'observacao', 'consultorios', 'farmacia', 'tv_panel', 'estagnacao', 'leitos', 'kanban', 'financeiro', 'tiss', 'relatorios', 'configuracoes'],
  ...
  if (role === 'Enfermeiro' || role === 'Enfermeira') {
    return {
      ...
      allowedTabs: ['dashboard', 'pacientes', 'escalas', 'atendimento', 'observacao', 'consultorios', 'farmacia', 'tv_panel', 'estagnacao', 'leitos', 'kanban'],
      canApproveUsers: false,
      canManageUsers: false,
      canDeleteRecords: false,
      canSignPEP: false,
  ...
  if (role === 'Gestor Financeiro' || role === 'Faturamento') {
    return {
      ...
      allowedTabs: ['dashboard', 'pacientes', 'financeiro', 'tiss', 'relatorios'],
      canApproveUsers: false,
      canManageUsers: false,
      canDeleteRecords: false,
      canSignPEP: false,
  ...
  if (role === 'Auxiliar de Enfermagem') {
    return {
      ...
      allowedTabs: ['dashboard', 'pacientes', 'escalas', 'atendimento', 'observacao', 'consultorios', 'leitos', 'kanban'],
      canApproveUsers: false,
      canManageUsers: false,
      canDeleteRecords: false,
      canSignPEP: false,
  ...
  return {
    ...
    allowedTabs: ['dashboard', 'pacientes', 'medicos', 'escalas', 'agenda', 'atendimento', 'observacao', 'consultorios', 'farmacia', 'tv_panel', 'estagnacao', 'leitos', 'kanban', 'relatorios'],
    canApproveUsers: false,
    canManageUsers: false,
    canDeleteRecords: false,
    canSignPEP: true,
